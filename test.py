...
if __name__ == "__main__":
    ...
    results.to_csv(os.path.join(results_dir, f'test_results.csv'), index=False)
    results.to_excel(os.path.join(results_dir, f'test_results.xlsx'), index=False)
    ...
    for code in results['tested_code'].drop_duplicates():
        ...
        agreement.to_csv(os.path.join(results_dir, f'test_agreement_{code}.csv'), index=False)
        agreement.to_excel(os.path.join(results_dir, f'test_agreement_{code}.xlsx'), index=False)
    ...
    metrics.to_csv(os.path.join(results_dir, 'test_metrics.csv'), index=False)
    metrics.to_excel(os.path.join(results_dir, 'test_metrics.xlsx'), index=False)
    print(metrics)  
